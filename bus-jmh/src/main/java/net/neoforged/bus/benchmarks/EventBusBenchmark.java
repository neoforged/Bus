...
public class EventBusBenchmark {
    private static final String ARMS_LENGTH = "net.neoforged.bus.benchmarks.compiled.BenchmarkArmsLength";
    ...
    public void setup() throws Exception {
        ...
        System.setProperty("test.harness.callable", "net.neoforged.bus.benchmarks.EventBusBenchmark$TestCallback");
