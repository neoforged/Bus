...
class Names {
    static final String SUBSCRIBE_EVENT = "Lnet/neoforged/bus/api/SubscribeEvent;";
    ...
    static final String LISTENER_LIST_HELPER = "Lnet/neoforged/bus/api/EventListenerHelper;";

    static final String EVENT = "Lnet/neoforged/bus/api/Event;";
